...
<body>
    <div class="container profile-sheet">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
               <input type="tel" class="form-control" id="phone" placeholder="Telephone/Contact Number">
            </div>
        </div>
       ...
       <div class="form-group row">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" class="form-control" id="familyInfo" placeholder="Enter Date Of Birth"></td>
                            <td><input type="text" class="form-control" id="familyInfo" placeholder="Enter Age"></td>
                        ...
                        <tr>
                            <td><center>Spouse (if married)</center>
                                <input type="text" class="form-control" id="familyInfo" placeholder="Enter Name" value="Spouse" hidden>
                            </td>
                            <td><input type="text" class="form-control" id="familyInfo" placeholder="Enter Name"></td>
                            <td><input type="text" class="form-control" id="familyInfo" placeholder="Enter Date Of Birth"></td>
                            <td><input type="text" class="form-control" id="familyInfo" placeholder="Enter Age"></td>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="contactContactnum" placeholder="Enter Contact Number (e.g 09XXXXXXX)">
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="dataMaybe">maybe</button>
                </div>
...
<script type="text/javascript">
    ...
    $(document).on('click','#dataSubmit',function(){ 
        ...
        familyInfoText.forEach((textbox) => {
            arrsfamilyInfo.push(textbox.value);
        });
        ...
        employmentHistText.forEach((textbox) => {
            arrsemploymentHist.push(textbox.value);
        });
        ...
        schoolDetailsText.forEach((textbox) => {
            arrsschoolDetails.push(textbox.value);
        });
        ...
        traininglistText.forEach((textbox) => {
            arrstraininglist.push(textbox.value);
        });
        ...
        governmentexamlistText.forEach((textbox) => {
            arrgovernmentexamlist.push(textbox.value);
        });
        ...
        characterReferenceText.forEach((textbox) => {
            arrcharacterReference.push(textbox.value);
        });
        ...
        contactpersonText.forEach((textbox) => {
            arrcontactperson.push(textbox.value);
        });
        ...
        if(expectedsalary == ""|| position == ""|| firstName == ""|| MiddleName == ""|| lastName == ""|| completecurrentaddress == "" || phone == ""){
