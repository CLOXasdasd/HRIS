              ...
              <div class="card-body">
                ...
                while($row=mysqli_fetch_array($sql)){ ?>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group" >
                                <label><span style="color:red">*</span> Date Filed</label>
                        ...
                        <div class="col-sm">
                            <div class="form-group" >
                                ...
                                <input type="text" name="date_filed" id="filed_date" class="form-control" value="<?php echo $row['shift_start'];?>" disabled>
                            </div>
                        </div>
                        <div class="col-sm">
                            <div class="form-group" >
