            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <center>   
                    ...
                    <?php } else {?>
                      <img src="../../admin/pages/profile_pic/normal.jpg" alt="Avatar" class="image--cover" >
                    <?php }?>
                </center>
                <br>
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
	                  	...
	                  	<div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          	<input type="text" class="form-control" id="username" placeholder="Email" value="<?php echo $_SESSION['emp_id']?>" disabled>
	                        </div>
	                    </div>
