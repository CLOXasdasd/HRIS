            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                        $sql=$fetchdata->selectAllNotifRequest();
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;"><?php  echo date("F d Y",$row['datefinished']); ?></td>
                            <td style="text-align:center;"><?php echo htmlentities($row['status']);?></td>
                            <td> <button type='button' id='<?php echo htmlentities($row['ITConcernID']);?>' class='reject_btn  btn-success btn-sm'  title='Edit Record'><i class='fa fa-edit' >View</i> </button></td>
                        </tr>
                    <?php } ?>
                  </tbody>
                </table>
...
<script>
    ...
    $(document).on('click','.reject_btn',function(){ 
        id=$(this).attr("id");
        location.href = "checkITConcen?id=" +id;
    });
</script>