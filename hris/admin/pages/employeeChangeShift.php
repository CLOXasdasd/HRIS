...
?>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                    ...
                    <li><a type="button" class="btn btn-success fa-download mr-1" data-toggle="modal" id="GenerateLeave"> Generate File</a></li>
                  ...
                  <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;"><?php echo ($row['date_filed1'] == '' ? ' ' : date("F d Y", strtotime($row['date_filed1']) )) ;?></td>
                            <!-- Here -->
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm">
                            <div class="form-group" >
                                ...
                                <select class="form-control" id="change_shiftfrom">
                                    ...
                                    for($x = 1 ; $x <= 23 ; $x++) {
                                          foreach ($min as $v) {?>
                                    <option value="<?php echo $x .":".$v; ?>"> <?php echo $x.":".$v; ?></option>                                   
                                    <?php } }?>                            
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group" >
                        ...
                        <select class="form-control" id="rep_employee_id">
                            <option value=""  selected> Select Person available Employee </option>
                            <?php
                            $sql=$fetchdata->selectEmployeeAccounts();
                            while($row=mysqli_fetch_array($sql)){ ?>
    ...
    <!-- Position modal -->
        ...
        <div class="modal fade GenerateModal" id="" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
...
<script>
   ...
   var id="";
    ...
    $(document).on('click','#generateFile',function(){ 
        ...
        location.href = "generateFileCSVChangeShift?startDate=" + startDate + "&endDate="+ endDate + "";
    });
</script>