<title>Notification Pass Type</title>
<?php 
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Notification Pass List</h3>
              </div>
                ...
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th style="text-align:center;">Approver 2 </th>
                                        <th style="text-align:center;">1st Approver  </th>
                    <th style="text-align:center;">2nd Approver </th>
                  </tr>
                  </thead>
                  <tbody>
                    <?php
                        $sql=$fetchdata->selectAllNotifPass();
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;"><?php echo htmlentities(date("F d Y H:i A",strtotime($row['date'])));?></td>
                            ...
                            <td style="text-align:center;"><?php echo $fetchdata->getApproverNAme($row['firstapprover']);?></td>
                            <td style="text-align:center;"><?php echo $fetchdata->getApproverNAme($row['secondapprover']);?></td>                                    
                        </tr>
                    <?php } ?>
                  </tbody>
                </table>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label><span style="color:red">*</span>Second Approver</label>
...
<script>
    ...
    $(document).on('click','.createDepartment',function(){ 
        ...
        if(employee_id == "" || date_filed== "" || notification =="" || secondapprover == ""){
            $.notify("Some innportant fields are empty!!! ", "error");
   ...
   var id="";
    ...
    $(document).on('click','#generateFile',function(){ 
        ...
        // alert(startDate + " || "+ endDate);
         location.href = "generateFilenotif?startDate=" + startDate + "&endDate="+ endDate + "";
    });
